...
```bash
npm install @test-analytics-neon/reporter
```
...
jobs:
  test:
    ...
    steps:
      ...
      - run: npm ci
      - run: npm install @test-analytics-neon/reporter
...
For issues and feature requests, visit: https://github.com/vijayravindran90/Test-Analytics-Neon
