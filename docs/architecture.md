...
### Shared Package (`@test-analytics-neon/shared`)
...
### Reporter Package (`@test-analytics-neon/reporter`)
...
- Can be published independently to npm as `@test-analytics-neon/reporter`
- Reusable across multiple projects
- Clear separation of concerns
- Easy versioning and updates

### Backend Package (`@test-analytics-neon/backend`)
...
### Frontend Package (`@test-analytics-neon/frontend`)
